...
export const MovieRegist = () => {
    return (
        
        <div><Button type="button" className="absolute top-2 right-2 bg-gray-500 p-2 rounded">
                    이전화면
                </Button>
        <form className="flex flex-col mt-20 gap-4 p-4 max-w-md mx-auto">
            ...
            <h1 className='mt-4'>포스터 이미지 업로드</h1> <Input type="file" className='border border-gray-300' />
